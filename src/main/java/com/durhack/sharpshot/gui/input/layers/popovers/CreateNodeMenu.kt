...
import com.durhack.sharpshot.gui.input.layers.popovers.createnode.NodeInfo
import com.durhack.sharpshot.gui.input.layers.popovers.createnode.SelectNodeType
import com.durhack.sharpshot.gui.input.layers.popovers.createnode.nodebuttons.AbstractNodeForm
...
class CreateNodeMenu : View() {
    ...
    private fun addNode(coordinate: Coordinate, node: AbstractNode?) {
        node ?: return
        globalContainer.nodes[coordinate] = node
